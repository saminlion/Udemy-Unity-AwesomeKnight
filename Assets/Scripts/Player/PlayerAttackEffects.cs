...
public class PlayerAttackEffects : MonoBehaviour
{
    ...
    public GameObject groundImpact_Prefab, kickFX_Prefab, fireTornado_Prefab, fireShield_Prefab, heal_Prefab, thunderFX_Prefab;
    ...
    void ThunderAttack()
    {
        for (int i = 0; i < 8; i++)
        {
            ...
            if (i == 0)
            {
                pos = new Vector3(transform.position.x - 4.0f, transform.position.y + 2.0f, transform.position.z);
            }
            ...
            {
                pos = new Vector3(transform.position.x, transform.position.y + 2.0f, transform.position.z - 4.0f);
            }
            ...
            {
                pos = new Vector3(transform.position.x + 2.5f, transform.position.y + 2.0f, transform.position.z + 2.5f);
            }
