...
public class PlayerAttack : MonoBehaviour
{
    ...
    void CheckInput()
    {
        ...
        {
            // fadeImages[0] meaning image thats at index 1 e.g. the second image
        ...
        {
            // fadeImages[0] meaning image thats at index 2 e.g. the second image
        ...
        {
            // fadeImages[0] meaning image thats at index 3 e.g. the second image
        ...
        {
            // fadeImages[0] meaning image thats at index 4 e.g. the second image
        ...
        {
            // fadeImages[0] meaning image thats at index 5 e.g. the second image
